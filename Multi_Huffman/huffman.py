...
class HuffTree(Tree):
    def __init__(self, flag, value=0, freq=0, child_tree0=None, child_tree1=None,
                 ...
                 child_tree8=None, child_tree9=None, child_tree10=None, child_tree11=None, child_tree12=None,
                 child_tree13=None, child_tree14=None):
...
def build_huff_tree(hufftrees_list, N):
    ...
    re_num = int(math.fmod(N, (15-1))) #15 branchs huffman tree
    ...
    while len(hufftrees_list) >1:
        ...
        if re_num >1 and times == 1:
            ...
            if re_num == 2:
                ...
                hufftree_new = HuffTree(12, 0, 0, trees_selected[0], trees_selected[1], trees_selected[2],
                                        trees_selected[3],trees_selected[4], trees_selected[5], trees_selected[6], trees_selected[7],
                                        trees_selected[8], trees_selected[9], trees_selected[10], trees_selected[11])
                hufftrees_list.append(hufftree_new)

            elif re_num == 13:
                hufftree_new = HuffTree(13, 0, 0, trees_selected[0], trees_selected[1], trees_selected[2],
                                        trees_selected[3],trees_selected[4], trees_selected[5], trees_selected[6], trees_selected[7],
                                        trees_selected[8], trees_selected[9], trees_selected[10], trees_selected[11],
                                        trees_selected[12])
                hufftrees_list.append(hufftree_new)
             
        elif(N == 14 or re_num==0) and times == 1:
            times += 1
            for i in range(14):
                trees_selected.append(hufftrees_list[i])

            hufftree_new = HuffTree(14, 0, 0, trees_selected[0], trees_selected[1], trees_selected[2], trees_selected[3],
                                trees_selected[4], trees_selected[5], trees_selected[6], trees_selected[7],
                                trees_selected[8],trees_selected[9], trees_selected[10], trees_selected[11], trees_selected[12],
                                trees_selected[13])
            hufftrees_list.append(hufftree_new)
            hufftrees_list = hufftrees_list[14:]

        else:
            for i in range(15):
                trees_selected.append(hufftrees_list[i])

            hufftrees_list = hufftrees_list[15:]
            # build a new huffman tree
            hufftree_new = HuffTree(15, 0, 0, trees_selected[0], trees_selected[1], trees_selected[2], trees_selected[3],
                                    trees_selected[4], trees_selected[5], trees_selected[6], trees_selected[7],
                                    trees_selected[8], trees_selected[9], trees_selected[10], trees_selected[11],
                                    trees_selected[12], trees_selected[13],trees_selected[14])#
            hufftrees_list.append(hufftree_new)
